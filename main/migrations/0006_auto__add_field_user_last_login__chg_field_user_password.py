...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_user', 'last_login',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


        # Changing field 'User.password'
        db.alter_column(u'main_user', 'password', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):
        # Deleting field 'User.last_login'
        db.delete_column(u'main_user', 'last_login')


        # Changing field 'User.password'
        db.alter_column(u'main_user', 'password', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        u'main.user': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '256'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
