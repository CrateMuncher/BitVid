...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.video'
        db.add_column(u'main_comment', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comments', null=True, to=orm['main.Video']),
                      keep_default=False)

        # Adding field 'VideoFile.video'
        db.add_column(u'main_videofile', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='video_files', null=True, to=orm['main.Video']),
                      keep_default=False)

        # Deleting field 'Channel.videoes'
        db.delete_column(u'main_channel', 'videoes_id')

        # Deleting field 'Video.video_files'
        db.delete_column(u'main_video', 'video_files_id')

        # Deleting field 'Video.comments'
        db.delete_column(u'main_video', 'comments_id')

        # Adding field 'Video.channel'
        db.add_column(u'main_video', 'channel',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='video', null=True, to=orm['main.Channel']),
                      keep_default=False)

        # Deleting field 'User.comments'
        db.delete_column(u'main_user', 'comments_id')


    def backwards(self, orm):
        # Deleting field 'Comment.video'
        db.delete_column(u'main_comment', 'video_id')

        # Deleting field 'VideoFile.video'
        db.delete_column(u'main_videofile', 'video_id')

        # Adding field 'Channel.videoes'
        db.add_column(u'main_channel', 'videoes',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Video']),
                      keep_default=False)

        # Adding field 'Video.video_files'
        db.add_column(u'main_video', 'video_files',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='video', null=True, to=orm['main.VideoFile']),
                      keep_default=False)

        # Adding field 'Video.comments'
        db.add_column(u'main_video', 'comments',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='video', null=True, to=orm['main.Comment']),
                      keep_default=False)

        # Deleting field 'Video.channel'
        db.delete_column(u'main_video', 'channel_id')

        # Adding field 'User.comments'
        db.add_column(u'main_user', 'comments',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='author', null=True, to=orm['main.Comment']),
                      keep_default=False)
