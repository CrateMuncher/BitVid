...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.created_date'
        db.delete_column(u'main_video', 'created_date')

        # Adding field 'Video.uploaded_date'
        db.add_column(u'main_video', 'uploaded_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 29, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Video.created_date'
        db.add_column(u'main_video', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 29, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Video.uploaded_date'
        db.delete_column(u'main_video', 'uploaded_date')
