...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'User.email'
        db.alter_column(u'main_user', 'email', self.gf('django.db.models.fields.CharField')(max_length=256))
